...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const response = yield (0, child_process_1.execSync)(`helm upgrade --debug --install -n ${config.namespace} ${config.chartName} .`);
